...
const addToCart = asyncHandler(async (req, res) => {
  ...
  cart.cartItems.forEach((item) => {
    const itemDiscount =
      item.productId.equals(productId) && product.discount
  ...
  res
    .status(201)
    .json(
      new ApiResponse(200, cart, "The product added to cart successfully.")
    );
});
...
const removeAProductFromCart = asyncHandler(async (req, res) => {
  ...
  if (!userId || !productId) {
    return res
      .status(400)
      .json(new ApiResponse(400, null, "User ID and Product ID are required"));
  }
...
const getUserCart = asyncHandler(async (req, res) => {
  ...
  res
    .status(201)
    .json(new ApiResponse(200, cart, "You get the user cart successfully"));
});
...
const clearCart = asyncHandler(async (req, res) => {
  ...
  res
    .status(201)
    .json(new ApiResponse(200, cart, "The cart cleared successfully"));
});
...
const getAllCart = asyncHandler(async (req, res) => {
  ...
  res.status(201).json(new ApiResponse(200, carts, "You got all the carts"));
});
...
const deleteCart = asyncHandler(async (req, res) => {
  ...
  res
    .status(201)
    .json(new ApiResponse(200, deleteResult, "The cart deleted successfully"));
});
