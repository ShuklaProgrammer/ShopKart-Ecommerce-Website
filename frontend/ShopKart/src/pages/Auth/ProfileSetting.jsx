    ...
    <section>
      <main className="sm:flex mx-2 sm:mx-0">
        <section className="sm:w-[80%] my-10">
          <h1 className="p-5 border-t border-l border-r border-gray-300 font-semibold uppercase">
            Account Settings
          </h1>
          <form
            action=""
            className="sm:flex justify-center gap-6 border border-1 border-gray-300 p-6 mb-10"
          >
            <div className="flex flex-col items-center">
              ...
              <div
                ...
                className="flex items-center justify-center bg-blue-300 sm:w-36 sm:h-36 w-20 h-20 rounded-full"
              >
                <img
                  src={profileImage}
                  alt=""
                  className="sm:w-36 sm:h-36 rounded-full"
                />
              </div>
            </div>
            <div className="flex flex-col w-full space-y-4">
              ...
              <div className="sm:flex items-center gap-5 space-y-4 sm:space-y-0">
                <div className="space-y-2 w-full">
                  ...
                  <div className="relative">
                    ...
                    />
                    <span
                      className="absolute right-2 top-1/2 transform -translate-y-1/2 text-blue-500 font-semibold cursor-pointer"
              ...
              <Button
                ...
                disabled={isLoading}
                onClick={(e) => {
                  handleCreateProfile(e, userInfo._id);
                }}
              >
                {isLoading ? (
          ...
          <form
            action=""
            className="space-y-4 border border-1 border-gray-300 p-6 mt-10"
          >
            ...
            <Button
              variant="shop"
              onClick={() =>
                navigate("/reset-password", { state: { text: "Change" } })
              }
            >
              Change Passowrd
            </Button>
