...
const OrderPage = () => {
  ...
  const {
    ...
    isLoading,
    isError,
  } = useGetUserOrderQuery({ orderedBy: userInfo._id, orderId });
  ...
  useEffect(() => {
    if (editAddress && currentAddressId !== null) {
      const addressData = orderDataAddress.find(
        (addr) => addr._id === currentAddressId
      );
  ...
  return (
    <section className="flex justify-center my-10">
      <form
        ...
        className="sm:flex justify-center gap-5 px-2 sm:px-0"
      >
        <section>
          <div className="border border-1 border-gray-300">
            <h1 className="text-lg font-semibold p-4 border-b border-gray-300">
              Delivery Address
            </h1>
            {orderDataAddress && orderDataAddress.length > 0 ? (
              orderDataAddress.map((addressData, index) => (
                <div
                  key={index}
                  className="flex items-baseline gap-2 border-1 border border-gray-300 sm:m-5 m-2 sm:p-5 p-2"
                >
                  <RadioGroup
                    value={formik.values.deliveryAddress}
                    onValueChange={(value) =>
                      formik.setFieldValue("deliveryAddress", value)
                    }
                  >
                    <div
                      onClick={() =>
                        formik.setFieldValue("deliveryAddress", addressData._id)
                      }
                  ...
                  <div className="w-full">
                    <div className="flex items-center justify-between">
                      ...
                      <h2
                        onClick={() => handleEditAddressClick(addressData._id)}
                    ...
                    <h4>
                      Phone Number: <span>{addressData.phoneNumber}</span>
                    </h4>
                    <h4>
                      Email: <span>{addressData.email}</span>
                    </h4>
                    {editAddress && currentAddressId === addressData._id && (
                      <form action="" className="w-full space-y-4 mt-10">
                        ...
                        <div className="flex items-center gap-5">
                          <Button variant="shop" onClick={handleUpdateAddress}>
                            Update Address
                          </Button>
                          <h2
                            className="text-lg text-blue-400 font-semibold hover:cursor-pointer"
            ...
            {formik.errors.deliveryAddress && formik.touched.deliveryAddress ? (
              <div className="text-red-500 text-sm font-semibold px-5 pb-4">
            ...
            {addNewAddress && (
              <div className="space-y-4 p-5">
                ...
                <div className="flex items-center gap-5">
                  ...
                  <h4
                    className="font-semibold text-blue-400 text-lg hover:cursor-pointer"
                    onClick={() => setEditAddress(false)}
                  >
                    Cancel
                  </h4>
          ...
          <div className="border border-1 border-gray-300 space-y-4 mt-10 mb-10">
            ...
            <RadioGroup
              ...
              className="flex items-center justify-between gap-10 border-t border-gray-300 p-4"
            >
              <div
                onClick={() =>
                  formik.setFieldValue("paymentOption", "Cash On Delivery")
                }
              ...
              <div
                onClick={() => formik.setFieldValue("paymentOption", "Online")}
                className="flex flex-col items-center justify-center hover:cursor-pointer"
              >
            ...
            {formik.touched.paymentOption && formik.errors.paymentOption ? (
              <div className="text-red-500 text-sm p-4 font-semibold">
          ...
          <div className="border border-1 border-gray-300 p-4 space-y-4">
            ...
            {order && (
              <p className="flex items-center justify-between">
                Total<span className="font-black">${order.totalPrice} USD</span>
              </p>
            )}
            <Button
              type="submit"
