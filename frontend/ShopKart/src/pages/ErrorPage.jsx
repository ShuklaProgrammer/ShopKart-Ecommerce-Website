    ...
    <section className="flex items-center justify-center my-10">
      <main className="flex flex-col items-center">
        ...
        <div className="space-x-5 mt-5">
          <Button onClick={() => navigate(-1)} variant="shop">
            <IoMdArrowBack className="text-xl mr-2" />
            Go Back
          </Button>
          <Button
            onClick={() => navigate("/")}
            className="bg-white border border-2 border-orange-500 text-orange-500 hover:bg-orange-100 font-semibold"
          >
            <FiHome className="text-xl mr-2" />
            Go To Home
          </Button>
        </div>
      </main>
