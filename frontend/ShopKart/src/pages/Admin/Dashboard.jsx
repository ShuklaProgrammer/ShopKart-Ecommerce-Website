...
const Dashboard = () => {
  const { data: getOrderStatistics, isLoading: orderStatisticsLoading } =
    useGetOrderStatisticsQuery({});
  // const {data: getAllOrders, isLoading: ordersLoading} = useGetAllOrdersQuery({})
  const { data: getTopStatesSales, isLoading: topSalesLoading } =
    useTopStatesBySalesQuery();
  const { data: getTopProductBySales, isLoading: topSalesProductLoading } =
    useTopProductBySalesQuery();
