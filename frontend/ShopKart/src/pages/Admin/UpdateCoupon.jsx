...
import { useGetCouponByIdQuery, useUpdateCouponByIdMutation } from '@/redux/api/couponApiSlice'
...
const UpdateCoupon = () => {
    ...
    useEffect(()=>{
        if(couponData && couponData.data._id){
            ...
            const expiryDate = couponData.data.couponExpiry.replace("Z", "")
            setCouponExpiry(expiryDate)
            setCouponMaxUses(couponData.data.couponMaxUses)
        }
    }, [couponData])
            ...
            <main className=''>
                <form action="" className='space-y-4'>
                    ...
                    <div className='space-y-2'>
                        ...
                        <Select value={couponType} onValueChange={(value) => setCouponType(value)}>
                    ...
                    <Button variant="shop" onClick={handleUpdateCoupon} className="w-full">Update Coupon</Button>
                    </div>
                    </div>
                </form>
            </main>
