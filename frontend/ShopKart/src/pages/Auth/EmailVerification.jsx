      ...
      <main className="bg-white shadow-2xl w-full mx-4 sm:mx-0 sm:w-[30%] pb-6">
        ...
        >
          <p className="text-center">
            Please enter your email address to proceed. We'll send a
  ...
  return (
    <section>
      {isClickedOnSendCodeButton ? (
        <VerifyEmail userInfo={userInfo} email={email} />
      ) : (
        <SendCode sendCodeClick={handleSendCodeClick} userInfo={userInfo} />
      )}
    </section>
  );
};
