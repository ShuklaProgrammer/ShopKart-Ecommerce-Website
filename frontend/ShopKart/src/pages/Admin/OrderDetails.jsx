      ...
      <main className="w-[90%] flex gap-6">
        <section className="w-[70%] space-y-6">
          <div className="p-5 space-y-4 shadow-lg py-6 rounded-lg">
            <h2 className="text-lg font-semibold p-3 bg-gray-100 rounded-lg">
              All Item
            </h2>
            {orderData &&
              orderData.orderItems?.map((item, index) => (
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <h4>Product Name</h4>
                      <span className="w-60 whitespace-nowrap overflow-hidden text-ellipsis block">
                        {item.productName}
                      </span>
                    </div>
                  </div>
        ...
        <section className="w-[50%] space-y-6">
          <div className="space-y-2 shadow-lg p-5 rounded-lg">
            ...
            <p className="flex justify-between">
              Order ID <span className="font-semibold">{orderData._id}</span>
            </p>
            <p className="flex justify-between">
              Date{" "}
