...
const AllProduct = () => {
  ...
  const { filterCategory, search, sort } = useSelector(
    (state) => state.product
  );
                  ...
                  <TableCell className="">
                    <div className="flex items-center gap-2 ">
                      <img
                        ...
                        className="w-12 h-12"
                      />
                      <p className="w-60 whitespace-nowrap overflow-hidden overflow-ellipsis">
                        {product.title}
                      </p>
                    </div>
                  </TableCell>
                      ...
                      <DropdownMenuContent>
                        <div className="flex flex-col">
                          <Link to={`/admin/update-product/${product._id}`}>
                            <p className="text-sm p-2 hover:bg-gray-200 hover:cursor-pointer">
                              Update Product
                            </p>
                          </Link>
                          <Link to={`/admin/${product._id}/add-discount`}>
                            <p className="text-sm p-2 hover:bg-gray-200 hover:cursor-pointer">
                              Add Discount
                            </p>
                          </Link>
