...
import { useSendEmailCodeMutation, useSendMobileCodeMutation, useVerifyEmailCodeMutation } from '@/redux/api/verificationApiSlice'
...
const ForgetPassword = () => {
  ...
  return(
    <section>
      {
        isClickedOnSendCode ? <VerifyCode/> : <SendCode/>
      }
    </section>
  )
}
