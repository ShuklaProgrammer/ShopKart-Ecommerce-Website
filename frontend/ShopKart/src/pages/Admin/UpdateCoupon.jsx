    ...
    <section className="w-full">
      <main className="">
        <form action="" className="space-y-4">
          <div
            className="w-[90%] h-56 border border-1 border-gray-300 flex items-center justify-center"
            ...
            <div className="w-full space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="outline outline-1 outline-gray-300 block"
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="Coupon Maximum Uses"
                  className="outline outline-1 outline-gray-300"
                />
              </div>
