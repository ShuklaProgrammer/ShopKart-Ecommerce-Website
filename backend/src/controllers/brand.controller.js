...
const updateBrand = asyncHandler(async(req, res) => {
    ...
    const updateBrand = await Brand.findByIdAndUpdate(brand._id, {brandName}, {new: true})

    res.status(201).json(
        new ApiResponse(200, updateBrand, "The brand updated successfully.")
    )
})
...
const getAllBrands = asyncHandler(async(req, res) => {
    ...
    res.status(201).json(
        new ApiResponse(200, brands, "You got all the brands successfully")
    )
})
...
const getBrandById = asyncHandler(async(req, res) => {
    ...
    res.status(201).json(
        new ApiResponse(200, brand, "You get brand by it's ID")
    )
})
...
const deleteBrandById = asyncHandler(async(req, res) => {
    ...
    res.status(201).json(
        new ApiResponse(200, brand, "You deleted brand successfully")
    )
})



export {createBrand, updateBrand, getAllBrands, getBrandById, deleteBrandById}