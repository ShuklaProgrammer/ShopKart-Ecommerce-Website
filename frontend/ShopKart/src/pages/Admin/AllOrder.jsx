...
const AllOrder = () => {
  ...
  const { data: getOrderById } = useGetOrderByIdQuery(selectOrderId, {
    skip: !selectOrderId,
  });
        ...
        <div className="flex justify-between">
          <div className="flex items-center relative w-[40%]">
            <Input
              ...
              className="rounded-sm outline outline-1 outline-gray-300"
          ...
          <TableBody>
            {orders.map((order, index) => (
              <TableRow key={index}>
                  ...
                  {order.orderItems?.slice(0, 1).map((item, index) => (
                    <div key={index} className="flex items-center gap-2">
                      <img
                        ...
                        className="w-10 h-10"
                      />
                      <p className="w-72 whitespace-nowrap overflow-hidden overflow-ellipsis">
                        {item.productName}
                      </p>
                    </div>
                  ))}
                ...
                <TableCell
                  className={`uppercase font-semibold ${getOrderStatusColor(
                    order.orderStatus
                  )}`}
                >
                  {order.orderStatus}
                ...
                <TableCell className="text-right">
                  <div className="flex items-center gap-2">
                    <FiEye
                      className="text-xl hover:cursor-pointer hover:text-orange-600"
                      onClick={() =>
                        handleViewOrderDetails(order._id, order.orderedBy)
                      }
                    />
                    <Dialog>
                      <DialogTrigger>
                                ...
                                <div>
                                  ...
                                  >
                                    ...
                                    <SelectContent>
                                      ...
                                      <SelectItem value="out_of_delivery">
                                        Out Of Delivery
                                      </SelectItem>
                    ...
                    <AlertDialog>
                      <AlertDialogTrigger>
                        <RiDeleteBin6Line className="text-xl hover:cursor-pointer hover:text-orange-600" />
                      </AlertDialogTrigger>
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          <AlertDialogTitle>
