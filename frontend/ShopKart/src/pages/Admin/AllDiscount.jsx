...
import { useDeleteDiscountMutation, useGetAllDiscountsQuery } from '@/redux/api/discountApiSlice'
                    ...
                    <TableBody>
                        {discounts.map((discount, index) => (
                            <TableRow key={index}>
                                ...
                                <TableCell className="text-right">{new Date(discount.discountExpiry).toLocaleString()}</TableCell>
                                    ...
                                    <DropdownMenu>
                                        ...
                                        <DropdownMenuContent>
                                            ...
                                            <div className='flex flex-col'>
                                                <Link to={`/admin/update-discount/${discount._id}`}><p className='text-sm p-2 hover:cursor-pointer hover:bg-gray-200'>Update Discount</p></Link>
                                                <AlertDialog>
                                                    <AlertDialogTrigger className='text-sm p-2 hover:bg-gray-200'>Delete Discount</AlertDialogTrigger>
                                                    <AlertDialogContent>
                                                        <AlertDialogHeader>
                                                        ...
                                                        <AlertDialogFooter>
                                                            ...
                                                            <AlertDialogAction onClick={()=>handleDeleteDiscount(discount._id)}>Delete</AlertDialogAction>
                                                        </AlertDialogFooter>
                                                    </AlertDialogContent>
                                                </AlertDialog>
                                            </div>
