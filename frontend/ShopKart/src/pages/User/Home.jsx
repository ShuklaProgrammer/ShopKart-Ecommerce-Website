    ...
    <section className='home-section flex justify-center mt-5'>
      <main className='bg-white w-[90%] h-full'>
        ...
        <section className='flex gap-5'>
          <div className='container1 flex justify-center items-center gap-10 h-[70vh] w-[70%] bg-gray-100 rounded-md'>
            ...
            <div className='w-[25rem] bg-red-300'>
              <img src="https://m.media-amazon.com/images/I/8195aYGDl9L._SL1500_.jpg" alt="" className='' />
            </div>
          </div>
          <div className='container2 flex flex-col gap-5 w-[30%] h-[70vh]'>
            <div className=' flex items-center gap-5 px-8 flex-grow bg-gray-800 rounded-md'>
              <div className='w-[15vw] flex flex-col space-y-3'>
                <span className='uppercase text-yellow-400'>Summer Sales</span>
                <h2 className='text-xl font-semibold w-[10vw] text-white'>Apple iPhone 15 (128 GB) - Black</h2>
            ...
            <div className='flex items-center flex-grow gap-5 px-8 bg-yellow-200 rounded-md'>
              <div className='w-[15vw]'>
                <img src="https://m.media-amazon.com/images/I/61-ZYvldY+L._SL1500_.jpg" alt="" />
              </div>
              <div className='w-[15vw] flex flex-col space-y-3'>
                <h2 className='text-xl font-semibold w-[10vw]'>OnePlus Nord Buds 2</h2>
        ...
        <section className='flex justify-between px-10 py-5 border-2 border-solid border-gray-200 border mt-5'>
        ...
        <section className='mt-10'>
          ...
          <div className='border-2 border border-solid border-gray-200 border mt-5'>
            ...
            <div className='grid grid-cols-5'>
              ...
              <div className='col-span-1 border-r-2'>
                <div className='flex justify-center'>
                  <img src={product.productImage[0]} alt="" className='w-[15vw] h-[15vw] mt-5 mb-3' />
                </div>
        ...
        <section>
          <h1 className='flex justify-center mt-12 mb-10 text-2xl font-semibold'>Shop with Categorys</h1>
        ...
        {/* banner section */}
        <section className='flex justify-between gap-5 mt-20'>
          <div className='flex bg-gray-300 p-5 items-center gap-5'>
            ...
            <img src="https://m.media-amazon.com/images/I/6182GmVZGLL._SL1080_.jpg" alt="" className='w-[22vw] h-[22vw]' />
          </div>
          <div className='flex bg-gray-800 p-5 items-center gap-5'>
            ...
            <img src="https://m.media-amazon.com/images/I/819sWoSDFRL._SL1500_.jpg" alt="" className='w-[22vw] h-[22vw]' />
          </div>
        </section>
        ...
        <section className='flex justify-between items-center px-20 bg-orange-200 mt-10 rounded-sm mb-10'>
          ...
          <img src="https://m.media-amazon.com/images/I/71an9eiBxpL._SL1500_.jpg" alt="" className='w-[22vw] h-[22vw]' />
        </section>
      </main>
    </section>
  )
