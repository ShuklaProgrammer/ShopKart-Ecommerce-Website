    ...
    <section className='flex justify-center sm:mx-10 my-10'>
      <form onSubmit={formik.handleSubmit} className='w-[90%] space-y-4'>
        ...
        <div className='space-y-2'>
          ...
          <Input id="deliveryEmail" value={formik.values.deliveryEmail} onChange={formik.handleChange} className="border-2 sm:w-[30vw]" placeholder="Email address"/>
        ...
        <p className='flex items-center gap-2'><AiOutlineInfoCircle className='text-2xl'/>Order ID that we sended to your in your email address.</p>
