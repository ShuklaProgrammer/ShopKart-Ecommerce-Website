        ...
        <section className="flex flex-grow">
            <main className='pb-10'>
              ...
              <div className='outline-gray-300 outline outline-1 w-[30vw] h-[40vh] hover:cursor-pointer hover:bg-gray-100 flex items-center justify-center' onClick={handleImageUploadClick}>
                ...
                {formik.values.productImage.length > 0 ? (
                  <img src={selectedImageIndex !== null
                    ? (formik.values.productImage[selectedImageIndex] instanceof File
                      ? URL.createObjectURL(formik.values.productImage[selectedImageIndex])
                    ...
                    : (formik.values.productImage[0] instanceof File
                      ...
                      : formik.values.productImage[0])} alt="" className='w-[60%]' />
                ) : (
                  <>
              ...
              <div className='overflow-x-auto w-[30vw] whitespace-nowrap'>
                {formik.values.productImage.map((image, index) => (
                  <div key={index} className='border border-1 border-gray-400 w-14 h-14 inline-block hover:cursor-pointer' onClick={() => handleThumbnailUpload(index)}>
                    <img src={image instanceof File ? URL.createObjectURL(image) : image} alt="" className='w-20' />
                  </div>
                ))}
              </div>
            ...
            <div>
                ...
                {!formik.values.productVideo ? (
                  ...
                  <div>
                    <video controls width={400} height={340}>
                      <source src={formik.values.productVideo instanceof File
              ? URL.createObjectURL(formik.values.productVideo)
              : formik.values.productVideo} type={formik.values.productVideo.type} />
                    </video>
                  </div>
                  )
                )}
              ...
              <Button variant="shop" type="button" onClick={handleVideoUploadClick} className="w-full">Upload Video</Button>
                        ...
                        <Button type="submit" disabled={formik.isSubmitting} variant="shop">{formik.isSubmitting ? <span className='flex items-center gap-2'>Updating Product...<Loader size='2em' topBorderSize='0.2em' center={false} fullScreen={false}/></span> : "Update Product" }</Button>
