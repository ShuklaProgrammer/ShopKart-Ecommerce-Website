      ...
      <main className="flex flex-col justify-center items-center text-center space-y-4">
        ...
        <div className="flex items-center sm:gap-5 gap-2">
          <Button
            ...
            className="bg-white text-orange-400 uppercase font-semibold border-2 border-orange-300 hover:bg-orange-50"
          >
            <PiStack className="text-xl sm:mr-2" />
            <span className="block sm:hidden">Dashboard</span>
            <span className="sm:block hidden">Go to Dashboard</span>
          </Button>
          <Button variant="shop" onClick={viewOrderDetails} className="">
            View Order
            <IoMdArrowForward className="text-xl sm:ml-2" />
          </Button>
        </div>
      </main>
    </section>
