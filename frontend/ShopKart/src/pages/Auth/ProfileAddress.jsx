...
const ProfileAddress = () => {
  ...
  useEffect(() => {
    if (editAddress && currentAddressId !== null) {
      const addressData = profileAddressData.find(
  ...
  return (
    <section className="sm:w-[80%] border-1 border border-gray-300 sm:p-6 p-2 my-10">
      ...
      {profileAddressData.length > 0 && (
        <div
          onClick={handleAddAddress}
          className="border-1 border border-gray-300 sm:p-4 p-2 hover:cursor-pointer"
        >
          <h1 className="flex items-center gap-3 text-blue-500 font-semibold">
            <GrAdd />
            Add More Addresses
          </h1>
        </div>
      ...
      {profileAddressData.map((addressData, index) => (
        <div
          key={index}
          className="border-1 border border-gray-300 sm:p-5 p-3 mt-5"
        >
          ...
          <Button
            onClick={() => handleEditAddress(addressData._id)}
            className="border-2 border-blue-500 bg-white text-blue-500 font-semibold hover:bg-blue-50 mt-4"
          >
            Edit Address
          </Button>
          <AlertDialog>
            <AlertDialogTrigger>
              <Button className="border-2 border-orange-400 bg-white text-orange-400 font-semibold hover:bg-orange-50 ml-4">
                Delete Address
              </Button>
            </AlertDialogTrigger>
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  ...
                  your address and remove your data from our servers.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
                ...
                <AlertDialogAction
                  ...
                  onClick={() => handleDeleteProfileAddress(addressData._id)}
                >
                  {isLoading === "deleteAddress" ? (
          ...
          {editAddress && currentAddressId === addressData._id && (
            <form action="" className="w-full space-y-4 mt-10">
              <h1 className="uppercase font-semibold text-blue-500">
                {editAddress ? "Edit Delivery Address" : "Add Delivey Address"}
              </h1>
              ...
              <div className="flex items-center gap-5">
                <Button
                  ...
                  onClick={
                    editAddress
                      ? handleUpdateProfileAddress
                      : handleCreateProfileAddress
                  }
                >
                  {editAddress ? (
                    <>
                      {isLoading === "updateAddress" ? (
                        <span className="flex items-center gap-2">
                          Updating...
                          <Loader
                            size="2em"
